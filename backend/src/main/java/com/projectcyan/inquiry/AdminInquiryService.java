...
public class AdminInquiryService {
	...
	public AdminInquiryService(
		...
		this(inquiryRepository, memberRepository, goodsRepository, Clock.systemUTC());
	}
	...
	public List<AdminInquiryRow> findAll() {
		...
		return inquiries.stream()
			...
			.map(inquiry -> toRow(inquiry, membersById, goodsById))
			.toList();
	}
	...
	private AdminInquiryRow toRow(Inquiry inquiry, Map<Long, Member> membersById, Map<Long, Goods> goodsById) {
